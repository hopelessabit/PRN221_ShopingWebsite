...
using System.IO; // Add this for Directory
...
namespace Core.Repositories
{
    public partial class ShopContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (!optionsBuilder.IsConfigured)
            {
                optionsBuilder.UseSqlServer("Data Source=ANN;Initial Catalog=PizzaStore;User ID=sa;Password=12345;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
            }
        }
        ...
        private string GetConnectionString()
        {
            ...
            return configuration["ConnectionStrings:String"] ?? string.Empty;
